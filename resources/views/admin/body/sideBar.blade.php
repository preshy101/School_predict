<aside id="layout-menu" class="layout-menu menu-vertical menu bg-dark  ">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2 text-white text-uppercase">Studie</span>
            </a>
          ...
          <ul class="menu-inner py-1  ">
            ...
            <!-- Layouts -->
             ...
             <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle text-white">
                ...
                <div data-i18n="Authentications" class="text-white">School</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a
                  href="{{route('school')}}"
                  class="menu-link" >
                    <div data-i18n="Basic">View School</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle text-white">
                ...
                <div data-i18n="Layouts" class="text-white">Departments</div>
              </a>
              <ul class="menu-sub">
            ...
            <li class="menu-item">
              <a href="javascript:void(0)" class="menu-link menu-toggle text-white">
                <i class="menu-icon tf-icons bx bx-box text-white"></i>
                <div data-i18n="User interface" class="text-white">Cutt offs </div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a
                   href="{{route('cutt')}}"
                   class="menu-link">
                    <div data-i18n="Accordion">View Cutt offs</div>
                  </a>
                </li>
            ...
            <li class="menu-item">
                <a
                 ...
                 class="menu-link">
                    ...
                    <div data-i18n="Boxicons" class="text-white">O'Level</div>
                </a>
            </li>
            ...
            <li class="menu-item">
                <a
                 ...
                 class="menu-link">
                    <i class="menu-icon tf-icons bx bx-money text-white"></i>
                    <div data-i18n="Boxicons" class="text-white">Postutme</div>
                </a>
            </li>
            <li class="menu-item">
                <a
